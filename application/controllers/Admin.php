...
class Admin extends CI_Controller {
    ...
    public function product_coupon()
    {
        ...
        $data['first_appr_coupon_trans'] = $this->main->get_join('coupon_transaction_header_tbl a', $join_coupon, FALSE, 'coupon_transaction_header_added DESC', FALSE, $coupon_trans_select, ['a.coupon_transaction_header_status' => 4]);
	...
	public function first_approve_transaction(){
		...
		if($_SERVER['REQUEST_METHOD'] == 'POST'){
			...
			if($category == 6 || $category == 7){ //* QR PROMO VOUCHER
				...
				$status = 1; //* final-approved if qr promo voucher
			}
