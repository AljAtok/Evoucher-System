...
class First_approver extends CI_Controller {
	...
	public function index()
    {
		...
		// redirect('first-approver/product-coupon');
		redirect('dashboard');
	}
    ...
    public function redeem_coupon()
    {
        ...
        $data['content'] = $this->load->view('first-approver/coupon/redeem_coupon_content', $data, TRUE);
        $this->load->view('first-approver/templates', $data);
    }
    ...
    public function standard_coupon()
    {
		...
		$data['top_nav']     = $this->load->view('fix/top_nav_content', $data, TRUE);
        $data['content']         = $this->load->view('first-approver/coupon/standard_coupon_content', $data, TRUE);
        $this->load->view('first-approver/templates', $data);
    }
    ...
    public function product_coupon()
    {
		...
		$data['top_nav']     = $this->load->view('fix/top_nav_content', $data, TRUE);
        $data['content']     = $this->load->view('first-approver/coupon/product_coupon_content', $data, TRUE);
        $this->load->view('first-approver/templates', $data);
    }
    ...
    public function modal_coupon_trans_details($id)
    {
        ...
        if ($check_id['result']) {
            ...
            $html = $this->load->view('first-approver/coupon/coupon_trans_modal_content', $data, TRUE);
    ...
    private function _success_coupon_trans_details($id)
    {
        ...
        return $this->load->view('first-approver/coupon/success_product_coupon_trans_details', $data, TRUE);
