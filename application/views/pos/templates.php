...
<html lang="en">
    ...
    <body  id="<?=$title?>">
        ...
        <div class="wrapper">
			...
			<?php $segment_one = 'redeem'; ?>
            <input type="hidden" value="<?=base_url($segment_one)?>" id="base_url">

            <!-- Sidebar -->
            <nav id="sidebar">
                <div class="sidebar-header text-center">
                    <img src="<?=base_url('assets/img/bounty-logo.png')?>" class="img-responsive">
                    <!-- <h6><strong><?=SYS_NAME?></strong></h6> -->
                    <h6></h6>
                </div>

                <ul class="list-unstyled components" id="main-menu">
					<li>
                        <a href="<?=base_url('redeem/redeem-coupon')?>"><strong><span class="fas fa-fw fa-stamp"></span> Redeem <?=SEC_SYS_NAME?></strong></a>
                    </li>
