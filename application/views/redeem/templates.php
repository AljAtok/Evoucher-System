        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components" id="main-menu">
					<li>
                        <a href="<?=base_url('redeem/redeem-coupon-v1')?>"><strong><span class="fas fa-fw fa-stamp"></span> Old Redeem <?=SEC_SYS_NAME?></strong></a>
                    </li>
					<li>
                        <a href="<?=base_url('redeem/redeem-coupon')?>"><strong><span class="fas fa-fw fa-stamp"></span> New Redeem <?=SEC_SYS_NAME?></strong></a>
                    </li>
