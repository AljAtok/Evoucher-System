                            ...
                            <table class="table table-striped table-condensed data-table">
                                ...
                                <tbody>
                                    <?php foreach($pending_coupon_trans as $row):
                                            ...
                                            $toggle = '<a href="#" title="Approve" class="first-approve-transaction" data-id="' . encode($row->coupon_transaction_header_id) . '"><span class="fas fa-arrow-circle-right fa-lg"></span></a>';
                                        ?>
                                    <tr>
                                        ...
                                        <td class="d-flex d-inline justify-content-center align-items-center">
                                            ...
                                            &nbsp;&nbsp;
                                            <!-- <a href="<?=base_url('admin/export-trans-details/') . encode($row->coupon_transaction_header_id)?>" target="_blank"><span class="fas fa-file-excel fa-lg text-success"></span></a>
                                            &nbsp;&nbsp;                                       -->
                            ...
                            <table class="table table-striped table-condensed data-table">
                                ...
                                <tbody>
                                    <?php foreach($approved_coupon_trans as $row): 
                                            $badge  = '<span class="badge badge-success">Approved</span>';
											$return_btn = '<a href="#" title="Back to Treasury Approved" class="return-first-approve-transaction" data-id="' . encode($row->coupon_transaction_header_id) . '"><span class="fas fa-arrow-circle-left fa-lg"></span></a>&nbsp;&nbsp;';
											...
											$edit_appr_btn = '<a href="#" title="Edit Approval" class="edit-approve-transaction" data-id="' . encode($row->coupon_transaction_header_id) . '"><span class="fas fa-edit fa-lg"></span></a>&nbsp;&nbsp;';
                                    ...
                                    <tr>
                                        ...
                                        <td >
											<div class="mb-1 d-flex justify-content-center align-items-center">
												<?php if ($row->payment_status == 0) :?>
													<a href="#" class="pay-transaction" data-id="<?=encode($row->coupon_transaction_header_id)?>"><span class="fas fa-money-bill fa-lg text-success"></span></a>
													&nbsp;&nbsp;
												<?php endif; ?>

												<?php if ($row->coupon_pdf_archived == 1) :?>
													
													<a title="Regenerate PDF" href="#" class="regenerate-pdf text-success" data-id="<?=encode($row->coupon_transaction_header_id) ?>">
														<i class="fas fa-undo fa-lg text-danger"></i>
													</a>
													&nbsp;&nbsp;
												<?php else: ?>
													<?= $return_btn ?>
													<a title="Archive PDF" href="#" class="archive-pdf text-success" data-id="<?=encode($row->coupon_transaction_header_id) ?>">
											...
											<?php if ($row->coupon_pdf_archived == 0) :?>
												<a title="Download Zipped PDF" href="<?=base_url('admin/zip-coupon/' . encode($row->coupon_transaction_header_id))?>" target="_blank"><i class="fas fa-file-archive fa-lg text-danger"></i></a>
												&nbsp;&nbsp;
											<?php endif; ?>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex d-inline justify-content-center align-items-center">
                                            ...
                                            <a href="<?=base_url('admin/export-trans-details/') . encode($row->coupon_transaction_header_id)?>" target="_blank"><span class="fas fa-file-excel fa-lg"></span></a>
                                            &nbsp;&nbsp;
                                            <?= $toggle ?>
                                        </td>
                                    </tr>
