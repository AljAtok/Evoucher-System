                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex d-inline text-center">
                                            <?php if ($row->payment_status == 0) :?>
                                                <a href="#" class="pay-coupon" data-id="<?=encode($row->coupon_id)?>"><span class="fas fa-arrow-circle-right fa-lg"></span></a>
                                                &nbsp;&nbsp;
                                            <?php endif; ?>
            ...
            <div class="modal fade" id="modal-add-standard-coupon" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('admin/store-standard-coupon')?>" class="needs-validation" enctype="multipart/form-data" novalidate>
            ...
            <div class="modal fade" id="modal-edit-standard-coupon" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('admin/update-standard-coupon')?>" class="needs-validation" enctype="multipart/form-data" novalidate>
                            <div class="modal-body">
                            </div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-secondary btn-sm" data-dismiss="modal">Close</button>
            ...
            <div class="modal fade" id="modal-approve-coupon" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('admin/approve-coupon')?>" id="approve-coupon" enctype="multipart/form-data">
                            <div class="modal-body">
                                <input type="hidden" name="id" id="id">
            ...
            <div class="modal fade" id="modal-cancel-coupon" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('admin/cancel-coupon')?>" id="cancel-coupon">
                            <div class="modal-body">
                                <input type="hidden" name="id" id="id">
            ...
            <div class="modal fade" id="modal-pay-coupon" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('admin/pay-coupon')?>" id="pay-coupon" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="modal-body">
                                <input type="hidden" name="id" id="id">
