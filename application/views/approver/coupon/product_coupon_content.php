                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="d-flex d-inline justify-content-center align-items-center">
                                            ...
                                            &nbsp;&nbsp; -->
                                            <!-- <a href="<?=base_url('approver/export-trans-details/') . encode($row->coupon_transaction_header_id)?>" target="_blank"><span class="fas fa-file-excel fa-lg"></span></a> -->
                                            &nbsp;&nbsp;<?= $toggle ?>
                                        </td>
                                    </tr>
                                    <?php endforeach;?>
            ...
            <div class="modal fade" id="modal-approve-transaction" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('approver/approve-transaction')?>" id="approve-transaction" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="modal-body">
            ...
            <div class="modal fade" id="modal-deactivate-transaction" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('approver/deactivate-transaction')?>" id="deactivate-transaction">
                            <div class="modal-body">
                                <input type="hidden" name="id" id="id">
            ...
            <div class="modal fade" id="modal-activate-transaction" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('approver/approve-transaction')?>" id="activate-transaction">
                            <div class="modal-body">
                                <input type="hidden" name="id" id="id">
            ...
            <div class="modal fade" id="modal-pay-transaction" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        ...
                        <form method="POST" action="<?=base_url('approver/pay-transaction')?>" id="pay-transaction" enctype="multipart/form-data" class="needs-validation" novalidate>
                            <div class="modal-body">
                                <input type="hidden" name="id" id="id">
