        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components" id="main-menu">
					...
					<!-- <li>
                        <a href="<?=base_url('approver/redeem-coupon')?>"><strong><span class="fas fa-fw fa-stamp"></span> Redeem <?=SEC_SYS_NAME?></strong></a>
                    </li> -->
					<li>
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled <?= (in_array($uri, $fm_links)) ? 'show' : '' ?>" id="fm-sub-menu">
                            <li>
                                <a href="<?=base_url('approver/product-coupon')?>"><span class="fas fa-fw fa-chevron-circle-right"></span>  Product <?=SEC_SYS_NAME?></a>
                            </li>
                        </ul>
                    </li>
