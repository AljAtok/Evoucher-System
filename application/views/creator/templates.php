        ...
        <div class="wrapper">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled components" id="main-menu">
                    ...
                    <li>
                        <a href="<?=base_url('creator/voucher-summary')?>"><strong><i class="far fa-fw fa-list-alt"></i> <?=SEC_SYS_NAME?> Summary</strong></a>
                    </li>
                    <li>
                        ...
                        <ul class="collapse list-unstyled <?= (in_array($uri, $fm_links)) ? 'show' : '' ?>" id="fm-sub-menu">
                            <li>
                                <a href="<?=base_url('creator/product-coupon')?>"><span class="fas fa-fw fa-chevron-circle-right"></span>  Product <?=SEC_SYS_NAME?></a>
                            </li>
                        </ul>
                    </li>
					<!-- <li>
