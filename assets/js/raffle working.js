...
async function renderTabs() {
	...
	renderTable(
		...
		[
			...
			{ label: "Name", key: "name" },
			{ label: "Draw TS", key: "winner_created_at" },
		],
		(row) =>
	...
	renderTable(
		...
		[
			{ label: "Ref. No.", key: "ref_no" },
			{ label: "Name", key: "name" },
			{ label: "Draw TS", key: "entry_created_at" },
		],
		(row) =>
			`<button class='btn btn-secondary btn-xs mr-1' onclick='confirmBackToNotValidated("${
				...
				row.name
			}")'>Back to Not Validated</button><button class='btn btn-primary btn-xs' onclick='showParticipantInfo(${JSON.stringify(
				row
			)})'>View</button>`,
		"Search validated winners..."
	);
	...
	renderTable(
		...
		[
			{ label: "Ref. No.", key: "ref_no" },
			{ label: "Name", key: "name" },
			{ label: "Entry TS", key: "entry_created_at" },
		],
		(row) =>
			`<button class='btn btn-primary btn-xs' onclick='showParticipantInfo(${JSON.stringify(
				row
